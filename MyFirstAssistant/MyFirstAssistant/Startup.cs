...
using MyFirstAssistant.Adapters;
using MyFirstAssistant.Bots;
using MyFirstAssistant.Dialogs;
using MyFirstAssistant.Services;
...
namespace MyFirstAssistant
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var supportedLocales = new List<string>() { "en-us", "pt-br", "de-de", "es-es", "fr-fr", "it-it", "zh-cn" };
